                        ...
                        switch (option) {
                            case 1:
                                try {
                                    ...
                                    service.adaugaBibliotecar(nume,prenume,email,nrTelefon,adresa,dataAngajare);
                                }
                                catch (Exception e) {
                            ...
                            case 2:
                                try {
                                    System.out.println("-------------------------");
                                    for(Bibliotecar bib : service.getBibliotecari()){
                                        bib.afisare();
                                    }
                                    System.out.println("-------------------------");
                                }
                    ...
                    while (true) {
                        ...
                        switch (option) {
                            case 1:
                                try {
                                    System.out.println("-------------------------");
                                    for(Carte carte : service.getCarti()){
                                        carte.afisare();
                                    }
                                    System.out.println("-------------------------");
                                }
                            ...
                            case 2:
                                try {
                                    System.out.println("-------------------------");
                                    for(CarteImprumutata carteImprumutata : service.getCartiImprumutate()){
                        ...
                        switch (option) {
                            case 1:
                                try {
                                    ...
                                    service.adaugaClient(nume,prenume,email,nrTelefon,adresa, tipClient,legitimatie);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                                }
                            ...
                            case 2:
                                try {
                                    ...
                                    service.adaugaCarte(titlu,numeAutor,numeEditura,isbn,numeCategorie);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                                }
                            ...
                            case 3:
                                try {
                                    ...
                                    service.imprumutaCarte(numarLegitimatie,titluCarte);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                                }
                            ...
                            case 4:
                                try {
                                    ...
                                    System.out.println("Titlu carte:");
                                    String titluCarte = s.nextLine();
                                    service.returnareCarte(numarLegitimatie,titluCarte);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                                }
                            ...
                            case 5:
                                try {
                                    ...
                                    service.adaugaAutor(numeAutor,prenumeAutor,tara);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                                }
                            ...
                            case 6:
                                try {
                                    ...
                                    service.adaugaEditura(numeEditura,adresaEditura);
                                    Thread.sleep(2000);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                            ...
                            case 7:
                                try {
                                    ...
                                    service.adaugaCategorie(numeCategorie, etaj, raft);
                                    Thread.sleep(2000);
                                }
                                catch (Exception e) {
                                    System.out.println("Eroare: " + e.getMessage());
                            ...
                            case 12:
                                try {
                                    System.out.println("-------------------------");
                                    for(Autor autor : service.getAutori()){
                            ...
                            case 13:
                                try {
                                    System.out.println("-------------------------");
                                    for(Editura editura : service.getEdituri()){
                            ...
                            case 14:
                                try {
                                    System.out.println("-------------------------");
                                    for(Categorie categorie : service.getCategorii()){
